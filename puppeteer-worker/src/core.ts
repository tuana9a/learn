...
import { Context, Job, runContext, DoingInfo } from "puppeteer-worker-job-builder";
...
export class PuppeteerWorker {
  ...
  async do(job: Job, opts: { pageIndex?: number; onDoing?: (info: DoingInfo) => any } = { pageIndex: 0, onDoing: () => null }) {
