package com.tuana9a.learnjavaservlet.configs;
...
public class AppConfig {
    ...
    public String createOAuthGoogleGetUserInfoUrl(String token) {
        return properties.getProperty("oauth.google.get_user_info_url") + token;
    }
